...
class _NavBarState extends State<NavBar> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer(
        ...
        listenWhen: (previous, current) => current is NavActionState,
        buildWhen: (previous, current) => current is! NavActionState,
        listener: (context, state) {
          if (state is SignOutFromNav) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
              content:
                  Text("Logout failed. An error occurred while signing out."),
            ));
          }
        },
        builder: (context, state) {
          switch (state.runtimeType) {
            case NavSuccessState:
              final successState = state as NavSuccessState;
