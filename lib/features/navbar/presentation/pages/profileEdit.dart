    ...
    Future<void> _submit() async {
      ...
      if(password.isNotEmpty) {
        ...
        if(faculty.isNotEmpty && dept.isEmpty){
          showDialog(
              context: context,
              builder: (context) => ShowAlertMessage(text: "Choose department"));
        }
            ...
            if (password == studentInfo.password) {
              try {
                await FirebaseFirestore.instance
                  ...
                  'studentID':
                      studentId.isNotEmpty ? studentId : studentInfo.id,
        ...
        showDialog(
            context: context,
            builder: (context) => ShowAlertMessage(text: "Enter your password"));
      }
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: (){
                  Navigator.push(
                      context, MaterialPageRoute(builder: (context)=> PassChangePage()));
                },
