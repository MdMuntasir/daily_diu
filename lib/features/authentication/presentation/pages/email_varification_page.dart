...
class EmailVerifyScreen extends StatefulWidget {
  ...
  EmailVerifyScreen({super.key, required this.isStudent, required this.docId});
        ...
        widget.isStudent
            ? await FirebaseFirestore.instance
                ...
                (value) async {
                  final snapshot = await _db
                      ...
                      .get();
                  StudentInfoModel userData = snapshot.docs
            ...
            : await FirebaseFirestore.instance
                ...
                final snapshot = await _db
                    ...
                    .where("email", isEqualTo: _user.email)
                    .get();
                TeacherInfoModel userData = snapshot.docs
      ...
      await _auth.currentUser?.sendEmailVerification().then(
        (value) {
          showDialog(
              context: context,
              builder: (context) =>
                  ShowAlertMessage(text: "Email has been Sent"));
        },
      );
    }
